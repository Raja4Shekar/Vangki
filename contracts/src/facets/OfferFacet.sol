...
//         LibVangki.OfferType offerType
//     );
//     event OfferAccepted(uint256 indexed offerId, uint256 loanId);
//     event OfferCancelled(uint256 indexed offerId);
...
//         // Check liquidity (simplified; integrate OracleFacet later)
//         LibVangki.LiquidityStatus liquidity = s.liquidAssets[lendingAsset]
//             ? LibVangki.LiquidityStatus.Liquid
//             : LibVangki.LiquidityStatus.Illiquid;
...
//         // if (offerType == LibVangki.OfferType.Lender) {
//         //     escrowDeposit(msg.sender, lendingAsset, amount); // To lender's escrow
//         // } else {
//         //     escrowDeposit(msg.sender, collateralAsset, collateralAmount); // To borrower's escrow
//         // }

//         // Lock assets (lender deposits principal, borrower deposits collateral)
//         if (offerType == LibVangki.OfferType.Lender) {
...
//         // Lock acceptor's assets
//         if (offer.offerType == LibVangki.OfferType.Lender) {
//             // Borrower accepting lender's offer: lock collateral
...
//             );
//         } else {
//             // Lender accepting borrower's offer: lock principal
...
//         // Mint NFTs (call VangkiNFTFacet internally later)
...
//         require(!offer.accepted, "Offer accepted");
//         address userVangkiEscrow = s.userVangkiEscrows[msg.sender];
